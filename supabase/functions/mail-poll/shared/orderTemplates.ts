// PLIK GENEROWANY — nie edytuj tutaj. Źródło: src/lib/orderTemplates/index.ts
// Wygenerowane przez scripts/build-edge-shared.mjs (patrz komentarz w skrypcie).

import type { ParsedOrder } from "./parsedOrder.ts";
import { detectQ4RoadOrder, parseQ4RoadOrder, detectQ4RoadWaybill, parseQ4RoadWaybill } from "./q4road.ts";
